...
# htmlWindow is a convenient way to create formatted texts in a frame
# instead of using many static text, html language can be used.
...
class MyFrame(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        htmlwin.SetPage(page)  # load html web page

        vbox.Add((-1, 10), 0)
        vbox.Add(htmlwin, 1, wx.EXPAND | wx.ALL, 9)

        bitmap = wx.StaticBitmap(panel, -1, wx.Bitmap('exit.png'))
