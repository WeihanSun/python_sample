# wx tutorial htmlWindow
# using htmlWindow to create help easily
...
class HelpWindow(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        toolbar.AddTool(2, 'Help', wx.Bitmap('new.bmp'))
        toolbar.Realize()

        self.splitter = wx.SplitterWindow(self, -1)  # split Window into 2
        ...
        close = wx.BitmapButton(header, -1, wx.Bitmap('exit.png', wx.BITMAP_TYPE_PNG),
		style=wx.NO_BORDER)
        ...
        #help.LoadPage('help.html')  # load html file
        help.LoadPage('http://www.kanzaki.com/docs/html/lesson1.html')
